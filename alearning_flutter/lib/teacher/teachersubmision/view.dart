...
class Viewsubmit extends StatelessWidget {
 ...
 final String name;
  ...
  Widget build(BuildContext context) {
    return Consumer<Teachercourseviewmodel>(builder: (BuildContext context, cours, Widget? child) {
     return ChangeNotifierProvider(create: (_) => Teachersubvm()..Fethdata(cours.courses),
        child: Padding(
                          ...
                          return Column(
                            children: [
                              ...
                              /*Consumer<Teachercourseviewmodel>(
                                builder: (BuildContext context, cours,
                                    Widget? child) {
                                  teachersubvm.Fethdata(cours.courses);
                              ...
                              SizedBox(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (BuildContext context,
                                    ...
                                    Color textcolor;
                                    switch (teachersubvm.assigns[index]
                                        .condition) {
                                      case "Late":
                                        textcolor =
